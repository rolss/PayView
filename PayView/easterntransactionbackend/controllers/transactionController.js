...
// BACKEND ONLY. Use this endpoint function to create a new East card in database.
const newCard = async (req,res) => {
    ...
    try {
        ...
        const card = await Card.create({cardName, cardNumber, expMonth, expYear, code, balance, company, bank: "East Bank", users: []})
