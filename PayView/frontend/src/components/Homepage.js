        ...
        <div>
                ...
                <div className="container-fluid">
                    <div className="row justify-content-center align-items-center mt-4 ms-lg-5 ms-4 pb-3">
                        <div className="col-12 col-xl-4 col-lg-5 col-md-5 col-sm-6 m-0 p-0 ms-sm-4 ms-lg-3 pe-xl-3">
                            ...
                            <p style={{ fontSize: '14px' }} className='mt-3 mb-4 pe-5 pe-sm-4 pe-md-5 text-left d-sm-block d-lg-none'>Make transactions and visualize your card information</p>
                            <button className="btn btn-warning btn-sm d-lg-none w-75">Get started</button>
                            <button className="btn btn-warning mt-sm-3 mt-2 btn d-lg-block d-none w-75">Get started</button>
                        </div>
            ...
            <section>
                <div className="container-fluid p-0">
                    <div className='alt-row row justify-content-center align-items-sm-center py-3 ms-1  g-0'>
                    ...
                    <div className='row justify-content-center align-items-sm-center'>
                        ...
                        <div className="col-12 col-sm-7 col-md-6 col-lg-5 col-xl-4 ms-sm-4 pe-sm-5 mb-4">
                            ...
                            <p className="lead d-md-block d-none">PayView transactions and accounts are encrypted and protected against malicious agents</p>
                            <p className="lead d-md-none d-sm-block d-none">PayView ensures protection against malicious agents</p>
                            <p style={{ fontSize: '16px' }} className="lead d-sm-none text-center px-5">PayView ensures protection against malicious agents</p>
                        </div>
                        <div className="col-4 my-5 d-sm-block d-none">
