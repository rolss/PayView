            ...
            <section>
                <div className="container-fluid">
                    <div className="row justify-content-center align-items-center">
                        <div className="col-4 mx-5 ps-5">
                            <h1 className="display-4 text-left">Welcome to <span className='d-block'>PayView</span></h1>
                            <p className='mt-4 pe-5 text-left'>Make transactions and visualize your card information with just a few clicks</p>
                ...
                <div className="container-fluid p-0">
                    ...
                    <div className='row p-0 m-0 justify-content-center align-items-center'>
                        <div className="col-4">
                            ...
                            <p className="pe-4 lead">PayView transactions and accounts are encrypted and protected from malicious agents</p>
                        </div>
                        <div className="col-4 my-5">
                            <img className='ms-5 mb-5' src={require('../img/security.png')} alt="" width={200} height={200}/>
                        </div>
                    </div>
                    ...
                    <div className='row p-0 m-0 justify-content-center align-items-center'>
                        ...
                        <p className="pe-4 lead">Get in touch with our customer support services at any time</p>
                        <button className="btn btn-warning">Contact us</button>
                        </div>
                        <div className="col-4 my-5">
                            <img className='ms-5 mb-5' src={require('../img/chat.png')} alt="" width={200} height={200}/>
                        </div>
                    </div>
                </div>
            </section>
